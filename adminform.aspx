...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
            ...
            <td class="auto-style3">
                ...
                <br />
                <br />
                 <asp:Button ID="Button4" runat="server" Height="39px" OnClick="Button4_Click" style="color: #FFFF00; font-weight: 700; background-color: #000066" Text="check messages" Width="112px" />
                 <br />
                <br />
                 <asp:Button ID="Button5" runat="server" Height="39px" OnClick="Button5_Click" style="color: #FFFF00; font-weight: 700; background-color: #000066" Text="give orders" Width="112px" />
                <br />
                <br />
                 <asp:Button ID="Button6" runat="server" Height="39px" OnClick="Button6_Click" style="color: #FFFF00; font-weight: 700; background-color: #000066" Text="check orders" Width="112px" />
            </td>
        </tr>
    </table>
